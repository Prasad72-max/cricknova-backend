    ...
    try {
      ...
      if (response.statusCode == 401) {
        ...
        try {
          ...
          if (decoded["detail"] == "PREMIUM_REQUIRED" ||
              decoded["detail"] == "ACCESS_DENIED") {
            await PremiumService.ensureFreshState();
            if (!PremiumService.isPremiumActive) {
              await _redirectToPremiumWithReason();
              return;
        ...
        String coachText = "No reply received from AI.";
        bool isSuccess = true;
        if (decoded is String && decoded.trim().isNotEmpty) {
          coachText = decoded.trim();
        ...
        // Only award XP / consume usage when the backend confirms success.
        if (isSuccess) {
                            ...
                            Padding(
                              ...
                              child: Align(
                                ...
                                child: Container(
                                  ...
                                  child: const Text(
                                    "CrickNova Coach: Your action plan is simple—fix your head position, shorten your run-up, and focus on one seam drill daily for 10 minutes...",
                                    maxLines: 2,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: PremiumBlurLock(
                                  locked: true,
                                  ctaText: "TALK TO CRICKNOVA COACH",
                                  title: "CrickNova Coach Locked",
                                  subtitle:
                                      "See full CrickNova coaching, personalised mistakes and drills with Premium.",
                                  onUnlock: unlock,
                                  child: ListView(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            "Hello ${getUserName()}!\nI am your CrickNova Coach. How can I help you improve your game today?",
                                            style: const TextStyle(
                                              color: Colors.white,
                                              fontSize: 14,
                                            ),
